...
class ProductResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'variationTypes' => $this->variationTypes ? $this->variationTypes->map(function ($variation_type) {
                return [
                    'id' => $variation_type->id,
                    'name' => $variation_type->name,
                    'type' => $variation_type->type,
                    'options' => $variation_type->options ? $variation_type->options->map(function ($option) {
                        return [
                            'id' => $option->id,
                            'name' => $option->name,
